	<nav class="navbar" role="navigation" id="navegacion">
		...
		<ul class="nav navbar-right top-nav nav-pills">
	    	...
	    	<li>
	    		<a href="<?php echo base_url(); ?>portal/nuevo_vendedor"><i class="fa fa-fw fa-plus-circle"></i>  Nuevo</a>
	    	</li>
	    	<li>
	        ...
	        <li class="dropdown">
	            ...
	            <ul class="dropdown-menu">
	                ...
	                <li>
	                    <a href="<?php echo base_url(); ?>portal/editar"><i class="fa fa-fw fa-edit"></i> Editar</a>
	                </li>
	                <li class="divider"></li>
	                <li>
